...
import ChatWork.Types ( ChatWorkResponse, GetRoomsResponse, PostRoomResponse
...
getRooms :: (MonadHttp m) => Token -> m (JsonResponse (ChatWorkResponse GetRoomsResponse))
getRooms = req GET (baseUrl /: "rooms") NoReqBody jsonResponse . mkTokenHeader

postRoom :: (MonadHttp m) => Token -> CreateRoomParams -> m (JsonResponse (ChatWorkResponse PostRoomResponse))
...
getRoom :: (MonadHttp m) => Token -> Int -> m (JsonResponse (ChatWorkResponse GetRoomResponse))
getRoom t n = req GET (baseUrl /: "rooms" /~ n) NoReqBody jsonResponse $ mkTokenHeader t

putRoom :: (MonadHttp m) => Token -> Int -> UpdateRoomParams -> m (JsonResponse (ChatWorkResponse PutRoomResponse))
...
deleteRoom :: (MonadHttp m) => Token -> Int -> DeleteRoomActionType -> m (JsonResponse (ChatWorkResponse ()))
...
getRoomMembers :: (MonadHttp m) => Token -> Int -> m (JsonResponse (ChatWorkResponse GetRoomMembersResponse))
getRoomMembers t n = req GET (baseUrl /: "rooms" /~ n /: "members") NoReqBody jsonResponse $ mkTokenHeader t

putRoomMembers :: (MonadHttp m) => Token -> Int -> RoomMembersParams -> m (JsonResponse (ChatWorkResponse PutRoomMembersResponse))
...
getRoomMessages :: (MonadHttp m) => Token -> Int -> Maybe Force -> m (JsonResponse (ChatWorkResponse GetRoomMessagesResponse))
...
postRoomMessage :: (MonadHttp m) => Token -> Int -> MessageBody -> m (JsonResponse (ChatWorkResponse PostRoomMessageResponse))
...
getRoomMessage :: (MonadHttp m) => Token -> Int -> Text -> m (JsonResponse (ChatWorkResponse GetRoomMessageResponse))
getRoomMessage t rid mid = req GET (baseUrl /: "rooms" /~ rid /: "messages" /~ mid) NoReqBody jsonResponse $ mkTokenHeader t

getRoomTasks :: (MonadHttp m) => Token -> Int -> GetTasksParams -> m (JsonResponse (ChatWorkResponse GetRoomTasksResponse))
...
postRoomTask :: (MonadHttp m) => Token -> Int -> CreateTaskParams -> m (JsonResponse (ChatWorkResponse PostRoomTaskResponse))
...
getRoomTask :: (MonadHttp m) => Token -> Int -> Int -> m (JsonResponse (ChatWorkResponse GetRoomTaskResponse))
getRoomTask t rid tid = req GET (baseUrl /: "rooms" /~ rid /: "tasks" /~ tid) NoReqBody jsonResponse $ mkTokenHeader t

getRoomFiles :: (MonadHttp m) => Token -> Int -> Maybe AccountId -> m (JsonResponse (ChatWorkResponse GetRoomFilesResponse))
...
getRoomFile :: (MonadHttp m) => Token -> Int -> Int -> Maybe CreateUrlFlag -> m (JsonResponse (ChatWorkResponse GetRoomFileResponse))
