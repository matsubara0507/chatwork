...
getRooms :: (MonadHttp m) => Token -> m (JsonResponse (ChatWorkResponse Rooms))
getRooms = req GET (baseUrl /: "rooms") NoReqBody jsonResponse . mkTokenHeader

postRoom :: (MonadHttp m) => Token -> CreateRoomParams -> m (JsonResponse (ChatWorkResponse RoomIdWrap))
...
getRoom :: (MonadHttp m) => Token -> Int -> m (JsonResponse (ChatWorkResponse RoomDetail))
getRoom t n = req GET (baseUrl /: "rooms" /~ n) NoReqBody jsonResponse $ mkTokenHeader t

putRoom :: (MonadHttp m) => Token -> Int -> UpdateRoomParams -> m (JsonResponse (ChatWorkResponse RoomIdWrap))
...
getRoomMembers :: (MonadHttp m) => Token -> Int -> m (JsonResponse (ChatWorkResponse Members))
getRoomMembers t n = req GET (baseUrl /: "rooms" /~ n /: "members") NoReqBody jsonResponse $ mkTokenHeader t

putRoomMembers :: (MonadHttp m) => Token -> Int -> RoomMembersParams -> m (JsonResponse (ChatWorkResponse PermissionMembers))
...
getRoomMessages :: (MonadHttp m) => Token -> Int -> Maybe Force -> m (JsonResponse (ChatWorkResponse Messages))
...
postRoomMessage :: (MonadHttp m) => Token -> Int -> MessageBody -> m (JsonResponse (ChatWorkResponse MessageIdWrap))
...
getRoomMessage :: (MonadHttp m) => Token -> Int -> Text -> m (JsonResponse (ChatWorkResponse Message))
getRoomMessage t rid mid = req GET (baseUrl /: "rooms" /~ rid /: "messages" /~ mid) NoReqBody jsonResponse $ mkTokenHeader t

getRoomTasks :: (MonadHttp m) => Token -> Int -> GetTasksParams -> m (JsonResponse (ChatWorkResponse RoomTasks))
...
postRoomTask :: (MonadHttp m) => Token -> Int -> CreateTaskParams -> m (JsonResponse (ChatWorkResponse TaskIdsWrap))
...
getRoomTask :: (MonadHttp m) => Token -> Int -> Int -> m (JsonResponse (ChatWorkResponse RoomTask))
getRoomTask t rid tid = req GET (baseUrl /: "rooms" /~ rid /: "tasks" /~ tid) NoReqBody jsonResponse $ mkTokenHeader t

getRoomFiles :: (MonadHttp m) => Token -> Int -> Maybe AccountId -> m (JsonResponse (ChatWorkResponse Files))
...
getRoomFile :: (MonadHttp m) => Token -> Int -> Int -> Maybe CreateUrlFlag -> m (JsonResponse (ChatWorkResponse File))
